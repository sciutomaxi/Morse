...
class morseTest extends FunSuite with BeforeAndAfter {
  ...
  test("Morse Service translateBinaryToMorse") {
    ...
    assert(morseServiceInst.translateBinaryToMorse("00000000110110110011100001111110001111110011111100000001110111111110111011100000001100011111100000000000000111111001111110000000110000110111111110111011100000011011100000000000") == ".... --- .-.. .-  -- . .-.. ..")
  }
